...
HD_PWD='C:/Users/Conor/Documents/ePWM_Project/ePWM_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log User.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source User.tcl -notrace
