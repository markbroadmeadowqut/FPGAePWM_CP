...
HD_PWD='C:/Users/Conor/Documents/ePWM_Project/ePWM_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log User.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source User.tcl
